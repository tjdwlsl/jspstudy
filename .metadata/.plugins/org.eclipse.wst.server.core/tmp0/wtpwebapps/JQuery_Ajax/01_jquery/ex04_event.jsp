...
<script type="text/javascript">
	//마우스 이벤트 : click(.on(), .bild()) ,dbclick(), .hover() mouseover(), mouseout(), .toggle()
...
$(document).ready( function(){
	...
	//}, function() {
	//	$("#img2").attr("src","../images/pic_bulboff.gif");
	//});
...
<body>
	...
	<p><span id="p3">풉풉풉풉풉</span></p>
	<p><img id="img" src="../images/pic_bulboff.gif"></p>
	<p><img id="img2" src="../images/pic_bulbon.gif"></p>
